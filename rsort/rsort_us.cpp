...
void rsort_us_1 (float* first, int numElements) {
...
__m128 xmm3;
    ...
    __m128i mask;
    __m128 blendMask;
    int endMaskIndex = numElements % 4;

    blendMask = _mm_load_ps(reinterpret_cast<float*>(&endBlendMask[4*endMaskIndex]));
...
{ __m128 t = xmm2;
  ...
  xmm3 = _mm_max_ps(xmm3, t);
    ...
    mask = _mm_load_si128(reinterpret_cast<__m128i*>(&endMask[4*endMaskIndex]));
    _mm_maskmoveu_si128(reinterpret_cast<__m128i>(xmm1), mask, reinterpret_cast<char*>(first + 0*4));
}

void rsort_us_2 (float* first, int numElements) {
...
void rsort_us_3 (float* first, int numElements) {
...
void rsort_us_4 (float* first, int numElements) {
...
void rsort_us_5 (float* first, int numElements) {
...
void rsort_us_6 (float* first, int numElements) {
...
void rsort_us_7 (float* first, int numElements) {
...
void rsort_us_8 (float* first, int numElements) {
...
void rsort_us_9 (float* first, int numElements) {
...
void rsort_us_10 (float* first, int numElements) {
...
void rsort_us_11 (float* first, int numElements) {
...
void rsort_us_12 (float* first, int numElements) {
...
void rsort_us_13 (float* first, int numElements) {
...
RegSort_UnalignedSmart_FuncPtr rsort_us_ptrs[13] = {
  rsort_us_1,
  rsort_us_2,
  rsort_us_3,
  rsort_us_4,
