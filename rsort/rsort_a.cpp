...
{ __m128 t = xmm15;
  ...
  xmm13 = _mm_max_ps(xmm13, t);
   ...
   _mm_store_ps(first + 12 * 4, xmm10);
}

RegSort_Aligned_FuncPtr rsort_a_ptrs[13] = {
  rsort_a_1,
  rsort_a_2,
  rsort_a_3,
  rsort_a_4,
